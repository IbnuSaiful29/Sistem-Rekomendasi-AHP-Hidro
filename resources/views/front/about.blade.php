...
<div class="body">
    ...
    <div role="main" class="main">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <ul class="breadcrumb d-block text-center custom-font-secondary text-6 font-weight-medium positive-ls-3">
                            ...
                            <li class="active text-color-primary">Tentang</li>
                        </ul>
                        <h1 class="d-block text-color-light font-weight-bold text-center text-12 positive-ls-1 line-height-2 mb-0">Tentang Kami</h1>
                    </div>
                </div>
            </div>
        ...
        <div id="aboutus" class="container py-5 mt-4 mb-3">
            <div class="row">
                <div class="col">
                    ...
                    <h3 class="text-color-dark text-transform-none text-9 line-height-3 font-weight-medium mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500">Menggunakan <span class="highlight highlight-primary highlight-bg-opacity highlight-animated" data-appear-animation="highlight-animated-start" data-appear-animation-delay="1200" data-plugin-options="{'flagClassOnly': true}">metode terbaik</span> untuk penanganan bencana banjir.</h3>
                    <p class="text-3-5 pb-2 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="700">Sistem ini dirancang untuk memberikan rekomendasi penanganan bencana banjir di wilayah Kabupaten Indramayu menggunakan metode Analytical Hierarchy Process (AHP). Metode ini memungkinkan kami untuk mengevaluasi berbagai alternatif penanganan berdasarkan kriteria yang telah ditetapkan.</p>
                    <p class="text-3-5 pb-2 mb-0 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="900">Dengan AHP, kami dapat menentukan prioritas penanganan yang paling efektif, efisien, dan tepat sasaran untuk meminimalkan dampak dari bencana banjir. Sistem ini memberikan solusi yang komprehensif dan terstruktur untuk menghadapi ancaman banjir, serta memastikan bahwa sumber daya yang tersedia digunakan secara optimal.</p>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="owl-carousel owl-theme carousel-half-full-width-right carousel-shadow-1 nav-bottom nav-bottom-align-left nav-style-1 nav-arrows-thin nav-dark nav-font-size-lg mb-0" data-plugin-options="{'responsive': {'0': {'items': 1}, '576': {'items': 2}, '768': {'items': 3}, '992': {'items': 4}, '1200': {'items': 4}}, 'loop': false, 'nav': true, 'dots': false, 'margin': 20}">
                                        <div>
                                            <a class="d-inline-block img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon" href="img/demos/restaurant/generic/generic-1.jpg">
                                                <img src="img/demos/restaurant/generic/generic-1.jpg" class="img-fluid box-shadow-4 rounded-0" alt="Rekomendasi 1" />
                                            </a>
                                        </div>
                                        <div>
                                            <a class="d-inline-block img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon" href="img/demos/restaurant/generic/generic-2.jpg">
                                                <img src="img/demos/restaurant/generic/generic-2.jpg" class="img-fluid box-shadow-4 rounded-0" alt="Rekomendasi 2" />
                                            </a>
                                        </div>
                                        <div>
                                            <a class="d-inline-block img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon" href="img/demos/restaurant/generic/generic-3.jpg">
                                                <img src="img/demos/restaurant/generic/generic-3.jpg" class="img-fluid box-shadow-4 rounded-0" alt="Rekomendasi 3" />
                                            </a>
                                        </div>
                                        <div>
                                            <a class="d-inline-block img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon" href="img/demos/restaurant/generic/generic-4.jpg">
                                                <img src="img/demos/restaurant/generic/generic-4.jpg" class="img-fluid box-shadow-4 rounded-0" alt="Rekomendasi 4" />
                                            </a>
                                        </div>
                                        <div>
                                            <a class="d-inline-block img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon" href="img/demos/restaurant/generic/generic-1.jpg">
                                                <img src="img/demos/restaurant/generic/generic-1.jpg" class="img-fluid box-shadow-4 rounded-0" alt="Rekomendasi 5" />
                                            </a>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="container py-5 mt-4 mb-1">
            <div class="row">
                <div class="col">
                    <p class="text-3-5 mb-0">Sistem ini juga dirancang untuk mempermudah koordinasi antar instansi terkait, memastikan bahwa setiap langkah yang diambil didasarkan pada data yang akurat dan analisis yang mendalam. Sistem ini memberikan laporan dan rekomendasi yang dapat diakses oleh pihak-pihak yang berkepentingan, sehingga transparansi dalam rekomendasi penanganan bencana banjir dapat terjaga. Dengan fitur ini, diharapkan keputusan yang diambil lebih tepat dan dapat dipertanggungjawabkan, membantu mengurangi kerugian akibat bencana banjir.
                    </p>
                </div>
            </div>
        </div>
