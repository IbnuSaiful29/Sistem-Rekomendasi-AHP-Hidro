            ...
            <ul class="side-menu">
                ...
                {{-- <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                            ...
                            class="side-menu__label">Perbandingan Kriteria</span><i
                            class="angle fe fe-chevron-right"></i></a>
                    <ul class="slide-menu">
                        <li><a href="{{route('pairwiseComparisonCriteria')}}" class="slide-item {{ $tittle === 'Perbandingan Kriteria' ? 'active' : '' }}">Perbandingan Berpasangan</a></li>
                        <li><a href="{{route('pairwiseComparisonCriteria')}}" class="slide-item {{ $tittle === 'Rangking Kriteria' ? 'active' : '' }}">Rangking Kriteria</a></li>
                    </ul>
                </li>
                <li class="slide"> --}}
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
