...
class CriteriaController extends Controller
{
    ...
    //     $normalizedMatrix = $this->normalizeMatrix($pairwiseComparisons, $criteria);
    //     $weights = $this->calculateWeights($normalizedMatrix, $criteria);
    //     $rankedCriteria = $this->rankCriteria($weights);

    //     dd($rankedCriteria);
    //     die;

    //     return view('ahp.ranking', compact('criteria', 'weights', 'rankedCriteria'));
    // }

    // private function normalizeMatrix($pairwiseComparisons, $criteria)
    // {
    ...
    //             $data = $pairwiseComparisons->where('criterion_row_id', $rowCriterion->id)
    //                                         ->where('criterion_col_id', $colCriterion->id)
    //                                         ->first();
    //             $value = $data ? $data->value : 0;
    //             $columnSum += $value;
    //         }
    //         $columnSums[$colCriterion->id] = $columnSum;
    //     }
    ...
    //                                         ->first();
    //             $value = $data ? $data->value : 0;
    //             $normalizedValue = $columnSums[$colCriterion->id] != 0 ? $value / $columnSums[$colCriterion->id] : 0;
    //             $normalizedMatrix[$rowCriterion->id][$colCriterion->id] = $normalizedValue;
    //         }
    //     }
    ...
    // private function calculateWeights($normalizedMatrix, $criteria)
    // {
    //     $weights = [];
    //     foreach ($criteria as $rowCriterion) {
    //         $sum = 0;
    //         foreach ($criteria as $colCriterion) {
    //             $sum += $normalizedMatrix[$rowCriterion->id][$colCriterion->id];
    //         }
    //         $weights[$rowCriterion->id] = $sum / count($criteria);
    //     }
    //     return $weights;
    // }

    // private function rankCriteria($weights)
    // {
    //     arsort($weights);
    //     return $weights;
    // }
