                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form class="form-horizontal" action="{{route('village-store')}}" method="POST">
                                @csrf
                                <div class=" row mb-4">
                                    <label for="inputName" class="col-md-3 form-label">Kabupaten</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="inputName" name="kabupaten_name" placeholder="Nama Kabupaten" required>
                                    </div>
                                </div>
                                <div class=" row mb-4">
                                    <label for="inputName" class="col-md-3 form-label">Kecamatan</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="inputName" name="kecamatan_name" placeholder="Nama Kecamatan" required>
                                    </div>
                                </div>
                                <div class=" row mb-4">
